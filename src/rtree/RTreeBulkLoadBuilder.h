...
#ifndef RTREEBULKLOADBUILDER_H
#define RTREEBULKLOADBUILDER_H

namespace rtree {

class RTreeBulkLoadBuilder: public std::enable_shared_from_this<RTreeBulkLoadBuilder>{
     ...
     */
    std::vector<std::shared_ptr<Node>> createLeafs(std::vector<Rectangle>& rectangles, int nodeCapacity);
