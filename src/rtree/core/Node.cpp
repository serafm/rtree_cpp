...
namespace rtree {
    ...
    level(level)
    {
        entriesMinX = std::vector<float>(RTreeBulkLoadBuilder::DEFAULT_MAX_NODE_ENTRIES);
        entriesMinY = std::vector<float>(RTreeBulkLoadBuilder::DEFAULT_MAX_NODE_ENTRIES);
        entriesMaxX = std::vector<float>(RTreeBulkLoadBuilder::DEFAULT_MAX_NODE_ENTRIES);
        entriesMaxY = std::vector<float>(RTreeBulkLoadBuilder::DEFAULT_MAX_NODE_ENTRIES);
        ids = std::vector<int>(RTreeBulkLoadBuilder::DEFAULT_MAX_NODE_ENTRIES);
    }
